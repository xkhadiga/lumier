...
{/* Movie Trailer Secxtion************** */}
    <div className='flex flex-col items-center mt-12'>
      ...
      <div className='playvid w-[80%] p-4 mx-10 mt-3 flex justify-center items-center rounded-2xl '>
        <iframe className="  w-full min-h-96 rounded-lg"  src={`http://www.youtube.com/embed/${vidKey}`}  allowFullScreen></iframe>
      </div>
